...
public class PdfOverlay extends system.proxies.FileDocument
{
	 ...
	 * @return value of MarginTop
	 */
	public final Double getMarginTop(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (Double) getMendixObject().getValue(context, MemberNames.MarginTop.toString());
	}
	 ...
	 * @param margintop
	 */
	public final void setMarginTop(com.mendix.systemwideinterfaces.core.IContext context, Double margintop)
	{
	 ...
	 * @return value of MarginLeft
	 */
	public final Double getMarginLeft(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (Double) getMendixObject().getValue(context, MemberNames.MarginLeft.toString());
	}
	 ...
	 * @param marginleft
	 */
	public final void setMarginLeft(com.mendix.systemwideinterfaces.core.IContext context, Double marginleft)
	{
	 ...
	 * @return value of MarginRight
	 */
	public final Double getMarginRight(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (Double) getMendixObject().getValue(context, MemberNames.MarginRight.toString());
	}
	 ...
	 * @param marginright
	 */
	public final void setMarginRight(com.mendix.systemwideinterfaces.core.IContext context, Double marginright)
	{
	 ...
	 * @return value of MarginBottom
	 */
	public final Double getMarginBottom(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (Double) getMendixObject().getValue(context, MemberNames.MarginBottom.toString());
	}
	 ...
	 * @param marginbottom
	 */
	public final void setMarginBottom(com.mendix.systemwideinterfaces.core.IContext context, Double marginbottom)
	{
