...
public class RichTextEntity
{
	 ...
	 * @return value of SanitizedText
	 */
	public final String getSanitizedText(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (String) getMendixObject().getValue(context, MemberNames.SanitizedText.toString());
	}
	 ...
	 * @param sanitizedtext
	 */
	public final void setSanitizedText(String sanitizedtext)
	{
	 ...
	 * @param sanitizedtext
	 */
	public final void setSanitizedText(com.mendix.systemwideinterfaces.core.IContext context, String sanitizedtext)
	{
