 ...
 * 
 * For Mendix < 9.6 this action keeps track of changes to the object except when 'changing to the same value'. For Mendix >= 9.6 this action keeps track of all changes.
 */
